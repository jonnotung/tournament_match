...
Revision ID: b7919ce4c4e9
Revises: 
Create Date: 2018-11-19 15:24:48.545558
...
def upgrade():
    ...
    op.create_table('user_tournament_assoc',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('user_tournament_assoc')
